...
export const configAlbum = {
    Время: {
        ...
        year: 2011,
        description: `
            Альбом включает как новые песни, так и новый взгляд на старые.        
        `
    },
    'Никто не ждёт': {
        name: 'Никто не ждёт',
        ...
        year: 2007,
        description: `
            Студенческая пора: любовь, экзамены, взгляд в будушее.    
        `
    },
    backToSchool: {
        name: 'backToSchool',
        ...
        year: 2004,
        description: `
            Воспоминания о школьных годах останутся в нашем сердце.    
        `
    }
}
