...
export const configAlbum = {
    Время: {
        ...
        year: 2011,
        description: `
            'Лето наших надежд'. Летняя тёплая романтика и первый снег, одинокий дождь и признания.
    ...
    'Никто не ждёт': {
        ...
        year: 2007,
        description: `
            Курсовые, экзамены, любовь, разочарования, друзья, а вместе с тем - мысли о настоящем и будущем...
    ...
    backToSchool: {
        ...
        description: `
            Год примерно 2004.
            Для записи использовали: подъезд городской пятиэтажки, две акустики, двухкассетник и хорошее настроение.
